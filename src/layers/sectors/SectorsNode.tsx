...
import { getBackdrop, getCopy, nodeSectors } from '../../data';
 ...
 * bands on stage) grows it into a hero with the tagline and a backdrop — the
 * authored `background_image` or a generated sector motif.
