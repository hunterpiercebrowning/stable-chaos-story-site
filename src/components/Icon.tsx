...
const PATHS: Record<string, ReactElement> = {
  ...
  /* ── product categories ── */
  /* DNA double helix — reads as biology for a non-technical audience. */
  bioproduct: (
    <>
      <path d="M7 3c0 4.5 10 4.5 10 9s-10 4.5-10 9" />
      <path d="M17 3c0 4.5-10 4.5-10 9s10 4.5 10 9" />
      <path d="M8.7 5h6.6M8.7 10h6.6M8.7 14h6.6M8.7 19h6.6" />
    </>
  ),
  /* Eight-tooth gear. */
  hardware: (
    <>
      <path d="M18.7 10.34l2.47.13v3.06l-2.47.13a6.9 6.9 0 0 1-.79 1.9l1.66 1.85-2.16 2.16-1.85-1.66a6.9 6.9 0 0 1-1.9.79l-.13 2.47h-3.06l-.13-2.47a6.9 6.9 0 0 1-1.9-.79l-1.85 1.66-2.16-2.16 1.66-1.85a6.9 6.9 0 0 1-.79-1.9l-2.47-.13v-3.06l2.47-.13a6.9 6.9 0 0 1 .79-1.9L4.43 6.59l2.16-2.16 1.85 1.66a6.9 6.9 0 0 1 1.9-.79l.13-2.47h3.06l.13 2.47a6.9 6.9 0 0 1 1.9.79l1.85-1.66 2.16 2.16-1.66 1.85a6.9 6.9 0 0 1 .79 1.9z" />
